...
import com.smalltown.rainsimpleexample.global.Constances;
import com.smalltown.rainsimpleexample.manager.RequestManager;
import com.smalltown.rainsimpleexample.ui.activity.MainActivity;
import com.smalltown.rainsimpleexample.ui.activity.SplashActivity;
...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     * @param transitionType 动画类型
     */
    protected void setPendingTransitionOut(int transitionType) {
        switch (transitionType) {
            case TRANS_TYPE_SHADE:
